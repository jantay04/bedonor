  ...
  return (
    <ProfileSidebarLayout>
      ...
      <div className=" mt-5 grid grid-cols-12 gap-[20px] max-sm:gap-[5px] text-[#2A5573]">
        <div className="col-span-5 max-lg:col-span-12 max-lg:order-first flex justify-center items-center sm:mt-[100px]">
          <img className="" src={coinkeeper} alt="" />
        </div>
        <div className='col-span-7 max-lg:col-span-12'>
          ...
          <div className="bg-[#D1E5F2]  sm:mt-[120px] mt-[20px] rounded-2xl">
            <div className="p-4 grid grid-cols-2 min-[460px]:grid-cols-3 sm:grid-cols-4 py-[60px] gap-[20px]">
              {progresses &&
                progresses.map((item) => (
