...
function NewsPage({ }: Props) {
    ...
    return (
        <MainLayout>
            <div className='container mx-auto p-4' onClick={() => console.log(data)}>
               
                <div className='grid grid-cols-2 lg:grid-cols-3 gap-5'>
                    {newskLists && newskLists.map((item) =>
                        <NewsCard id={item.id} title={item.title} description={item.description} createdDate={item.createdDate} img={item.imageUrl} />
                    )}
                </div>
